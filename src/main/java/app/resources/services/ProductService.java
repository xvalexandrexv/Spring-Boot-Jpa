...
import app.resources.repository.ProductRepository;
...
public class ProductService {
    ...
    public List<Product> findAll() { // fizemos uma operaçao na camada de serviço que repassa para o repository.findall
