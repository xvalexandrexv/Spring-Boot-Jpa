...
import app.resources.services.ProductService;
...
@RequestMapping(value = "/products") // isto para da o nome
public class ProductController {

    @Autowired
    private ProductService productService; // este autowired estra dependente do CategoryService atravez da anotçao @Service
    ...
    public ResponseEntity<List<Product>> findAll() { // o response entity e um tipo especifico so spring gera respostas de requisiçoes web
        List<Product> list = productService.findAll(); // e este e para mostrar para o utlizador
